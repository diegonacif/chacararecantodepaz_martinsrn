  ...
  return (
    ...
    <div>
      ...
      <ul>
        <li>
          <aside>
            <a href="https://maps.app.goo.gl/GEbhpaWGNfd97rA56" target="_blank" id="site-link">
        ...
        <li>
          <aside>
            <a href="https://maps.app.goo.gl/YinQyGh7Xrc37MaW9" target="_blank" id="site-link">
        ...
        <li>
          <aside>
            <a href="https://maps.app.goo.gl/E9sSvTrWeden2vWk9" target="_blank" id="site-link">
        ...
        <li>
          <aside>
            <a href="https://maps.app.goo.gl/Z34c4jzFbWGtBzYQA" target="_blank" id="site-link">
