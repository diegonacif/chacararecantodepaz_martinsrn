    ...
    <AttractionComponentContainer>
      ...
      <div>
        ...
        <ul>
          <li>
            <aside>
              <a href="https://maps.app.goo.gl/33TS1iU9CMRzg8Mg6" target="_blank" id="site-link">
                Mirante do Canto
              </a>
            </aside>
          </li>
          <li>
            <aside>
              <a href="https://maps.app.goo.gl/DGVX7FGPxzUSiSsy7" target="_blank" id="site-link">
                Mirante da Carranca
              </a>
            </aside>
          </li>
          <li>
            <aside>
              <a href="https://maps.app.goo.gl/njZMZn1UpL2Egxe56" target="_blank" id="site-link">
                Mirante Penhasco
              </a>
            </aside>
          </li>
          <li>
            <aside>
              <a href="https://maps.app.goo.gl/duqyjWGdRHmPHfuN6" target="_blank" id="site-link">
          ...
          <li>
            <aside>
              <a href="https://maps.app.goo.gl/3Js7Ewa318qD83BB6" target="_blank" id="site-link">
                Mirante Mãe Guilé
              </a>
            </aside>
          </li>
